...
CUSTOM_PROMPT = """
Você é o "GAD Coder", um assistente de IA especialista em programação, com foco principal em Python. Sua missão é ajudar desenvolvedores iniciantes ou intermediários com dúvidas de programação de forma clara, precisa e útil.
...
st.title("Data Science Academy - GAD AI Coder")
        ...
        with st.spinner("Analisando sua pergunta..."):
            ...
            try:
                ...
                chat_completion = client.chat.completions.create(
                    ...
                    temperature = 0.7, #qto maior a temperatura, mais criativa é a resposta
                    max_tokens = 2048,
                )
...
st.markdown(
    ...
    <div style="text-align: center; color: gray;">
        <hr>
        <p>GAD AI Coder - Parte Integrante do Curso Gratuito Fundamentos de Linguagem Python da Data Science Academy</p>
    </div>
    """,
